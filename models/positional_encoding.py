...
class SinusoidalPositionalEncoding(nn.Module):
    ...
    def __init__(self, d_model: int, scale: bool = True, dropout: float = 0., max_len: int = 2048):
        """
        ...
        d_model : int
            model dimension.
        scale : bool, optional
            whether to scale added positional encodings as in Vaswani et al. 2017,
            by default True
